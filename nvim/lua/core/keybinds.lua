...
vim.keymap.set("n", "<leader>l", "<cmd>LazyGit<CR>", {desc= "Open/Execute the lazygit plugin"})
...
vim.keymap.set('n', '<leader>fs',"<cmd>Telescope grep_string<CR>", { desc = 'Telescope grep strings' })
